            ...
            if (exposePresent && categoryPresent) {
                ...
                for (Field optionField : categoryObj.getClass().getDeclaredFields()) {
                    ...
                    if (optionPresent) {
                        ...
                        if (optionField.isAnnotationPresent(ConfigEditorInfoText.class)) {
                            ConfigEditorInfoText configEditorAnnotation = optionField.getAnnotation(ConfigEditorInfoText.class);
                            editor = new GuiOptionEditorInfoText(
                                option,
                                configEditorAnnotation.infoTitle()
                            );
                        }
